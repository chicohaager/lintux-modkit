#!/bin/bash
# install-with-firewall.sh — generated from install.sh by tools/gen-installers.sh, do not edit.
# Installs or updates these Lintux modules on a ZimaOS host: zfw, cron, zbackup.
